...
void setup() {
  ...
  //    if (b < 100*(1.0/(range - 1))) pixels[i] = color(100*(1.0/(range - 1)));
  //  }
  //}
  //updatePixels();
  ...
  //loadPixels();
  //for(int i = 0; i < pixels.length; i++){
  //  if(pixels[i] == pallette[0]) pixels[i] = pixels1[i];
  //  else if(pixels[i] == pallette[1]) pixels[i] = pixels2[i];
  //  else pixels[i] = pixels3[i];
  //}
  //updatePixels();
}
